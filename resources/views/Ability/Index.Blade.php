    ...
    <div class="bg-white rounded-lg">
        <div class="p-8">
            ...
            <div class="flex justify-between">
                <form action="{{ route('users.abilities.create') }}" method="get">
                    @csrf
                    <button
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex gap-2">
                                        <a href="{{ route('users.abilities.edit', $ability->id) }}" role="button"
                                            class="btn btn-primary text-white"><i class="fa-solid fa-pencil"></i></a>
                                        <form action="{{ route('users.abilities.destroy', $ability->id) }}" method="post"
